export const LlamaIndexLogo = ({ className }: { className?: string }) => (
  <svg
    className={className}
    height="1em"
    ...
    aria-labelledby="llamaindexTitle"
  >
    <title id="llamaindexTitle">LlamaIndex</title>
    <defs>
      <linearGradient
        gradientUnits="userSpaceOnUse"
        id="lobe-icons-llamaindex-fill"
        x1="4.021"
        x2="24.613"
        y1="2.02"
        y2="19.277"
      >
        <stop offset=".062" stopColor="#F6DCD9" />
        <stop offset=".326" stopColor="#FFA5EA" />
        <stop offset=".589" stopColor="#45DFF8" />
    ...
    <path
      ...
      fill="url(#lobe-icons-llamaindex-fill)"
    />
  </svg>
);
