export const MailchimpLogo = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 512 512"
    xmlns="http://www.w3.org/2000/svg"
    aria-labelledby="mailchimpTitle"
  >
    <title id="mailchimpTitle">Mailchimp</title>
    <rect width="512" height="512" rx="15%" fill="#ffe01b" />
    <path
      fill="#1e1e1e"
