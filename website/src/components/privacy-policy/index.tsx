    ...
    <div className="px-4 py-6 font-['Inter']">
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          <strong>voltagent.dev</strong> (hereinafter referred to as{" "}
          <strong>“Service”</strong>).
        </p>
        <p>
          Our Privacy Policy governs your visit to{" "}
          <strong>voltagent.dev</strong>, and explains how we collect, safeguard
      ...
      <div className="mb-6">
        ...
        <p>
          <strong>SERVICE</strong> means the voltagent.dev website operated by
          VoltAgent
        </p>
        <p>
      ...
      <div className="mb-6">
        ...
        <p>
          If you are located outside of Ireland and choose to provide
          information to us, please note that we transfer the data, including
          Personal Data, to Ireland and process it there.
        </p>
        <p>
        ...
        <p>
          VoltAgent Inc. will take all the steps reasonably necessary to ensure
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            ...
            at <strong>info@voltagent.dev</strong>
          </li>
        </ul>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            <strong>To stop selling your personal information.</strong> We don’t
      ...
      <p>
        ...
        by email: <b>info@voltagent.dev</b>.
      </p>
      <p className="mt-20 text-xs">
        This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
        was created for <b>voltagent.dev</b> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2025-05-17.
      </p>
    </div>
  );
}
