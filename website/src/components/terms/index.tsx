    ...
    <div className="px-6 py-12 font-['Inter']">
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          of our website located at <b>voltagent.dev</b>
        ...
        <p>
          ...
          <b>info@voltagent.dev</b> so we can try to find a solution. These
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          VoltAgent Inc. cancels it. You may cancel your Subscription renewal
          either through your online account management page or by contacting
          info@voltagent.dev customer support team.
        </p>
        <p>
          A valid payment method is required to process the payment for your
          subscription. You shall provide VoltAgent with accurate and complete
          ...
          you automatically authorize VoltAgent to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, VoltAgent Inc.
      ...
      <div className="mb-6">
        ...
        <p>
          VoltAgent Inc. may, at its sole discretion, offer a Subscription with
        ...
        <p>
          ...
          Trial, you will not be charged by VoltAgent Inc. until Free Trial has
        ...
        <p>
          At any time and without notice, VoltAgent Inc. reserves the right to
      ...
      <div className="mb-6">
        ...
        <p>
          VoltAgent Inc., in its sole discretion and at any time, may modify
        ...
        <p>
          VoltAgent Inc. will provide you with a reasonable prior notice of any
      ...
      <div className="mb-6">
        ...
        <p>
          Content found on or through this Service are the property of VoltAgent
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            Use any robot, spider, or other automatic devices, processes, or
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          property of VoltAgent Inc. and its licensors. Service is protected by
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          to info@voltagent.dev, with the subject line: “Copyright Infringement”
      ...
      <div className="mb-6">
        ...
        <p>
          You can contact our Copyright Agent via email at info@voltagent.dev.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p>
          You may provide us either directly at info@voltagent.dev or via
          ...
          the Feedback. In the event the transfer of the ownership to the
          ...
          free-of-charge, sublicensable, unlimited and perpetual right to use
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          that are not owned or controlled by VoltAgent Inc.
        </p>
        <p>
          VoltAgent Inc. has no control over, and assumes no responsibility for
      ...
      <div className="mb-6">
        ...
        <p>
          EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART
          OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          laws of US/California, which governing law applies to the agreement
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          support by email to: <b>info@voltagent.dev</b>.
        </p>
      </div>
