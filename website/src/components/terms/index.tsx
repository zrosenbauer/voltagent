...
export function TermsAndConditions() {
  return (
    <div className="px-6 py-12 font-['Inter']">
      <h2 className="text-center font-bold text-2xl mb-8">TERMS AND CONDITIONS</h2>
      <p className="mb-4">Last updated: 2025-05-17</p>
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          located at <b>voltagent.dev</b>
          (together or individually “Service”) operated by <b>VoltAgent</b>.
        </p>
        <p>
        ...
        <p>
          ...
          acknowledge that you have read and understood Agreements, and agree to be bound by them.
        </p>
        <p>
          If you do not agree with (or cannot comply with) Agreements, then you may not use the
          Service, but please let us know by emailing at <b>info@voltagent.dev</b> so we can try to
      ...
      <div className="mb-6">
        <p className="font-bold">2. Communications</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">3. Purchases</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">4. Contests, Sweepstakes and Promotions</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">5. Subscriptions</p>
        <p>
          Some parts of Service are billed on a subscription basis ("Subscription(s)"). You will be
          billed in advance on a recurring and periodic basis ("Billing Cycle"). Billing cycles will
          be set depending on the type of subscription plan you select when purchasing a
          Subscription.
        </p>
        <p>
          At the end of each Billing Cycle, your Subscription will automatically renew under the
          exact same conditions unless you cancel it or VoltAgent Inc. cancels it. You may cancel
          your Subscription renewal either through your online account management page or by
          contacting info@voltagent.dev customer support team.
        </p>
        <p>
          A valid payment method is required to process the payment for your subscription. You shall
          provide VoltAgent with accurate and complete billing information that may include but not
          limited to full name, address, state, postal or zip code, telephone number, and a valid
          payment method information. By submitting such payment information, you automatically
          authorize VoltAgent to charge all Subscription fees incurred through your account to any
          such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, VoltAgent Inc. reserves the right
          to terminate your access to the Service with immediate effect.
        </p>
      </div>

      <div className="mb-6">
        <p className="font-bold">6. Free Trial</p>
        <p>
          VoltAgent Inc. may, at its sole discretion, offer a Subscription with a free trial for a
        ...
        <p>
          ...
          charged by VoltAgent Inc. until Free Trial has expired. On the last day of Free Trial
        ...
        <p>
          At any time and without notice, VoltAgent Inc. reserves the right to (i) modify Terms of
          Service of Free Trial offer, or (ii) cancel such Free Trial offer.
        </p>
      </div>

      <div className="mb-6">
        <p className="font-bold">7. Fee Changes</p>
        <p>
          VoltAgent Inc., in its sole discretion and at any time, may modify Subscription fees for
          the Subscriptions. Any Subscription fee change will become effective at the end of the
          then-current Billing Cycle.
        </p>
        <p>
          VoltAgent Inc. will provide you with a reasonable prior notice of any change in
      ...
      <div className="mb-6">
        <p className="font-bold">8. Refunds</p>
        <p>
          We issue refunds for Contracts within <b>30 days</b> of the original purchase of the
          Contract.
        </p>
      </div>

      <div className="mb-6">
        <p className="font-bold">9. Content</p>
        <p>
          Content found on or through this Service are the property of VoltAgent Inc. or used with
      ...
      <div className="mb-6">
        <p className="font-bold">10. Prohibited Uses</p>
        <p>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            Use any robot, spider, or other automatic devices, processes, or means to access Service
      ...
      <div className="mb-6">
        <p className="font-bold">11. Analytics</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">12. No Use By Minors</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">13. Accounts</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">14. Intellectual Property</p>
        <p>
          Service and its original content (excluding Content provided by users), features, and
          functionality are and will remain the exclusive property of VoltAgent Inc. and its
          ...
          without the prior written consent of VoltAgent Inc.
        </p>
      </div>

      <div className="mb-6">
        <p className="font-bold">15. Copyright Policy</p>
        <p>
        ...
        <p>
          ...
          submit your claim via email to info@voltagent.dev, with the subject line: “Copyright
          Infringement” and include in your claim a detailed description of the alleged Infringement
          as detailed below, under “DMCA Notice and Procedure for Copyright Infringement Claims.”
        </p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">16. DMCA Notice and Procedure for Copyright Infringement Claims</p>
        <p>
        ...
        <p>You can contact our Copyright Agent via email at info@voltagent.dev.</p>
      </div>

      <div className="mb-6">
        <p className="font-bold">17. Error Reporting and Feedback</p>
        <p>
          You may provide us either directly at info@voltagent.dev or via third-party sites and
          ...
          confidential information or proprietary information from you or any third party; and (iv)
          Company is not under any obligation of confidentiality with respect to the Feedback. In
          the event the transfer of the ownership to the Feedback is not possible due to applicable
          mandatory laws, you grant Company and its affiliates an exclusive, transferable,
          irrevocable, free-of-charge, sublicensable, unlimited and perpetual right to use
      ...
      <div className="mb-6">
        <p className="font-bold">18. Links To Other Web Sites</p>
        <p>
          Our Service may contain links to third-party web sites or services that are not owned or
          controlled by VoltAgent Inc.
        </p>
        <p>
          VoltAgent Inc. has no control over, and assumes no responsibility for the content, privacy
      ...
      <div className="mb-6">
        <p className="font-bold">19. Disclaimer Of Warranty</p>
        <p>
        ...
        <p>
          ...
          ANYONE ASSOCIATED WITH COMPANY REPRESENTS OR WARRANTS THAT THE SERVICES, THEIR CONTENT, OR
          ANY SERVICES OR ITEMS OBTAINED THROUGH THE SERVICES WILL BE ACCURATE, RELIABLE,
      ...
      <div className="mb-6">
        <p className="font-bold">20. Limitation Of Liability</p>
        <p>
          ...
          REGULATIONS, EVEN IF COMPANY HAS BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH
          DAMAGE.
        </p>
        <p>
          EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL
          BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES
      ...
      <div className="mb-6">
        <p className="font-bold">22. Governing Law</p>
        <p>
          These Terms shall be governed and construed in accordance with the laws of US/California,
          which governing law applies to the agreement without regard to its conflict of law
          provisions.
        </p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">23. Changes To Service</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">24. Amendments To Terms</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">25. Waiver And Severability</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">26. Acknowledgement</p>
        <p>
      ...
      <div className="mb-6">
        <p className="font-bold">27. Contact Us</p>
        <p>
          Please send your feedback, comments, and requests for technical support by email to:{" "}
      ...
      <p className="mt-20 text-xs">
        These{" "}
        <a href="https://policymaker.io/terms-and-conditions/" className="underline">
          Terms of Service
        </a>{" "}
        were created for <b>voltagent.dev</b> by{" "}
        <a href="https://policymaker.io" className="underline">
          PolicyMaker.io
        </a>{" "}
        on 2025-05-17.
      </p>
