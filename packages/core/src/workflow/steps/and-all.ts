...
export function andAll<
  ...
  SUSPEND,
  RESUME,
  STEPS extends ReadonlyArray<InternalWorkflowStep<INPUT, DATA, RESULT, SUSPEND, RESUME>>,
>({ steps, ...config }: WorkflowStepParallelAllConfig<STEPS>) {
  ...
  } satisfies WorkflowStepParallelAll<INPUT, DATA, INFERRED_RESULT, SUSPEND, RESUME>;
}
